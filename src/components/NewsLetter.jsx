...
const NewsLetter = () => {
  return (
    <div className="flex mt-20 mb-20 flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
 <Title title="Stay Inspired" subTitle="join our newletter and be the first to discover new destination,exclusive offers,and travle inspiration"/>
